...
- [x] **Step 1: Add failing product-shape and presentational tests**
...
- [x] **Step 3: Implement the utility and presentational modules**
...
- [x] **Step 1: Add failing tests for clear, keyboard suggestion, and active category**
...
- [x] **Step 4: Re-run Header tests and confirm they pass**
...
- [x] **Step 1: Add failing tests for card controls, keyboard access, fallback, and empty state**
...
- [x] **Step 2: Run the focused ProductCard/ProductGrid tests and confirm they fail**
...
- [x] **Step 3: Implement ProductCard and ProductGrid**
...
- [x] **Step 4: Re-run ProductCard/ProductGrid tests and confirm they pass**
...
- [x] **Step 1: Add failing tests for item totals and the $50 threshold**
...
- [x] **Step 2: Run the focused CartDrawer tests and confirm they fail**
...
- [x] **Step 4: Re-run CartDrawer tests and confirm they pass**
...
- [x] **Step 1: Add failing dialog and close-action tests**
...
- [x] **Step 2: Run focused modal tests and confirm they fail**
...
- [x] **Step 3: Extract and implement the modal modules**
...
- [x] **Step 4: Re-run modal tests and confirm they pass**
...
- [x] **Step 1: Replace inline component definitions with imports**
...
- [x] **Step 2: Add component-specific styles**
...
- [x] **Step 3: Run the component test file**

Run: `npm test -- --reporter=verbose tests/components.test.jsx`
Expected: PASS for utilities, Header, product cards/grid, cart drawer, and modals.

- [x] **Step 4: Run the full test suite and production build**
...
- [x] **Step 5: Mark Task 4 complete and write the requested report**
...
- [x] **Step 6: Review and commit only Task 4 files**
